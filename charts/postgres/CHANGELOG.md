...
* feat(pgsql): merged initscript to avoid mount error, fixed quote from… (#13) ([d1f2cc6](https://github.com/GitGuardian/gitguardian-helm-charts/commit/d1f2cc6))
...
* chore(deps): update docker.io/postgres:18.0 Docker digest to 073e7c8 (#172) ([f4b12f4](https://github.com/GitGuardian/gitguardian-helm-charts/commit/f4b12f4))
* implement support for existingClaim (#212) ([805d3f8](https://github.com/GitGuardian/gitguardian-helm-charts/commit/805d3f8))

## 0.7.0 (2025-09-30)

* make postgres run on openshift (#184) ([0396895](https://github.com/GitGuardian/gitguardian-helm-charts/commit/0396895))

## 0.6.1 (2025-09-29)

* update default postgres config files (#180) ([6385512](https://github.com/GitGuardian/gitguardian-helm-charts/commit/6385512))
* [postgres]: Default config (#163) ([fc0da25](https://github.com/GitGuardian/gitguardian-helm-charts/commit/fc0da25))
...
* [postgres]: Default config (#163) ([fc0da25](https://github.com/GitGuardian/gitguardian-helm-charts/commit/fc0da25))
* [postgres]: Fix invalid data dir path on postgres 18 (#165) ([7592892](https://github.com/GitGuardian/gitguardian-helm-charts/commit/7592892))

## 0.5.4 (2025-09-26)

* chore(deps): update docker.io/postgres:17.6 Docker digest to 0b6428e (#161) ([1946296](https://github.com/GitGuardian/gitguardian-helm-charts/commit/1946296))

## 0.5.3 (2025-09-25)

* support custom pg_hba.conf (#157) ([9f3ceea](https://github.com/GitGuardian/gitguardian-helm-charts/commit/9f3ceea))
...
* added support for service account configuration (#15) ([541a9df](https://github.com/GitGuardian/gitguardian-helm-charts/commit/541a9df))
